...
- **Python Installation**: Ensure Python is installed. The application uses Python 3.12.3 but is compatible with versions from 3.6 and later. Download from the [official website](https://www.python.org/downloads/).
